...
<div class="card" class:bought={wish.b}>
  ...
  <div class="body">
    ...
    <div class="top">
      <span class="name" style="color:{wish.b ? '#3A5A1A' : '#3D2010'}">{esc(wish.n)}</span>
    ...
    <div class="actions">
      ...
      <button class="btn-bought" style="background:{wish.b ? '#A07850' : '#6A8A4A'}" onclick={toggle}>{wish.b ? 'Annulla' : 'Segna comprato'}</button>
    </div>
  </div>
</div>

<style>
  .card { border-radius: 16px; overflow: hidden; border: 1.5px solid #EDD9C0; margin-bottom: 10px; }
  .card.bought { border-color: #A0C060; background: #EEF4E4; }
  ...
  .bought-badge { font-size: 11px; color: #FFF; font-weight: 700; background: #6A8A4A; padding: 3px 10px; border-radius: 20px; display: inline-block; margin-bottom: 6px; }
  ...
  .detail { font-size: 12px; color: #A07850; font-weight: 600; margin-bottom: 4px; }
  .budget { font-size: 12px; color: #7B1FA2; font-weight: 700; margin-bottom: 4px; }
  .link { font-size: 12px; color: #C4622D; text-decoration: none; font-weight: 700; display: inline-block; margin-bottom: 6px; }
  .actions { display: flex; gap: 7px; margin-top: 8px; }
  .btn-remove { all: unset; background: #C4622D; color: #FFF; border-radius: 9px; padding: 7px 13px; font-size: 12px; cursor: pointer; font-weight: 700; display: inline-block; }
  .btn-bought { all: unset; border-radius: 9px; padding: 7px 13px; font-size: 12px; cursor: pointer; font-weight: 700; display: inline-block; color: #FFF; }
</style>
